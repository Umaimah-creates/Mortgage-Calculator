...
st.markdown("""
    <style>
        ...
        .stTextInput label, .stNumberInput label, .stMetric label, h1, h2, h3, h4, h5, h6 {
...
# Plot dark theme graph using Matplotlib
st.write('### Payment Schedule')
fig, ax = plt.subplots()
ax.plot(df['Month'], df['Remaining Balance'], color='cyan', linewidth=2)
